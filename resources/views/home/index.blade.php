                    ...
                    <div class="showcase-slider owl-carousel">
                        <div class="item">
                            <div class="screenshot-thumb">
                                <img src="themes/slick/img/showcase/01.jpg" class="img-fluid" alt="" />
                                <div class="hover-content text-center">
                                    <div class="fancy-table">
                                        <div class="table-cell">
                                            ...
                                            <div class="zoom-icon">
                                                <a class="lightbox" href="themes/slick/img/showcase/01.jpg"><i class="lni-zoom-in"></i></a>
                        ...
                        <div class="item">
                            <div class="screenshot-thumb">
                                <img src="themes/slick/img/showcase/02.jpg" class="img-fluid" alt="" />
                                <div class="hover-content text-center">
                                    <div class="fancy-table">
                                        <div class="table-cell">
                                            <div class="single-text">
                                            ...
                                            <div class="zoom-icon">
                                                <a class="lightbox" href="themes/slick/img/showcase/02.jpg"><i class="lni-zoom-in"></i></a>
                                                <a href="#"><i class="lni-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="screenshot-thumb">
                                <img src="themes/slick/img/showcase/03.jpg" class="img-fluid" alt="" />
                                <div class="hover-content text-center">
                                    <div class="fancy-table">
                                        <div class="table-cell">
                                            <div class="single-text">
                                            ...
                                            <div class="zoom-icon">
                                                <a class="lightbox" href="themes/slick/img/showcase/03.jpg"><i class="lni-zoom-in"></i></a>
                                                <a href="#"><i class="lni-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="screenshot-thumb">
                                <img src="themes/slick/img/showcase/04.jpg" class="img-fluid" alt="" />
                                <div class="hover-content text-center">
                                    <div class="fancy-table">
                                        <div class="table-cell">
                                            <div class="single-text">
                                            ...
                                            <div class="zoom-icon">
                                                <a class="lightbox" href="themes/slick/img/showcase/04.jpg"><i class="lni-zoom-in"></i></a>
                                                <a href="#"><i class="lni-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="screenshot-thumb">
                                <img src="themes/slick/img/showcase/05.jpg" class="img-fluid" alt="" />
                                <div class="hover-content text-center">
                                    <div class="fancy-table">
                                        <div class="table-cell">
                                            <div class="single-text">
                                            ...
                                            <div class="zoom-icon">
                                                <a class="lightbox" href="themes/slick/img/showcase/05.jpg"><i class="lni-zoom-in"></i></a>
                                                <a href="#"><i class="lni-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                ...
                                <div class="client-thumb">
                                    <img src="themes/slick/img/testimonial/01.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <div class="team-thumb">
                            <img src="themes/slick/img/team/01.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <div class="team-thumb">
                            <img src="themes/slick/img/team/02.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <div class="team-thumb">
                            <img src="themes/slick/img/team/03.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-xs-12">
                    <div class="single-team">
                        <div class="team-thumb">
                            <img src="themes/slick/img/team/04.jpg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="row">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="themes/slick/img/blog/01.jpg" class="img-fluid" alt="">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="themes/slick/img/blog/02.jpg" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="blog-item-text">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                    ...
                    <div class="blog-item-wrapper">
                        <div class="blog-item-img">
                            <a href="single-post.html">
                                <img src="themes/slick/img/blog/03.jpg" class="img-fluid" alt="">
                            </a>
                        </div>
                        <div class="blog-item-text">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="contact-img">
                        <img src="themes/slick/img/contact/01.png" class="img-fluid" alt="">
                    </div>
                </div>
                <!-- End Col -->
                <!-- Start Col -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                        ...
                        <div class="footer-logo">
                            <img src="themes/slick/img/footer-logo.png" alt="">
                        </div>
                    </div>
                    <!-- End Col -->
                    <!-- Start Col -->
