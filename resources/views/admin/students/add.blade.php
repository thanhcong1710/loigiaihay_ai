    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <form method="post" action="{{ route('admin.students.store') }}" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    <div class="mb-7">
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="ma_crm" value="" disabled>
                        ...
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input class="form-control" placeholder="Chọn ngày sinh" id="kt_daterangepicker_1" name="date_of_birth" value="" required />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="province_id" id="province_id" data-control="select2" data-placeholder="Chọn tỉnh thành phố" data-allow-clear="true" onchange="loadDistricts()" required>
                                    <option></option>
                        ...
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="school_grade" id="school_grade" data-control="select2" data-placeholder="Chọn độ tuổi" data-allow-clear="true" required>
                                    <option></option>
                        ...
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="source" id="source" data-control="select2" data-placeholder="Chọn nguồn" data-allow-clear="true" required>
                                    <option></option>
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_name1" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_mobile1" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_email1" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input class="form-control" placeholder="Chọn ngày sinh" id="kt_daterangepicker_2" name="gud_birth_day1" required />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="gud_job1" id="gud_job1" data-control="select2" data-placeholder="Chọn nghề nghiệp" data-allow-clear="true" required>
                                    <option></option>
                                    @foreach($jobs As $job)
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_name2" value="">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_mobile2" value="">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="text" class="form-control " name="gud_email2" value="">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input class="form-control" placeholder="Chọn ngày sinh" id="kt_daterangepicker_3" name="gud_birth_day2"  />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="gud_job2" id="gud_job2" data-control="select2" data-placeholder="Chọn nghề nghiệp" data-allow-clear="true" >
                                    <option></option>
                                    @foreach($jobs As $job)
                                    <option value="{{$job->id}}">{{$job->title}}</option>
                                    @endforeach
                    ...
                    <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                        <div class="col">
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <select class="form-select" name="branch_id" id="branch_id" data-control="select2" data-placeholder="Chọn trung tâm" data-allow-clear="true" onchange="loadBranchInfo()" required>
                                    <option></option>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" id="kt_modal_new_card_submit" class="btn btn-success">
                            <span class="indicator-label"><i class="fa-solid fa-floppy-disk"></i>Thêm mới</span>
                        </button>
                    </div>
                </form>
            </div>
